          ...
          <Card className="p-4 mb-4">
            <div className="relative">
              ...
              <input
                ...
                value={searchTerm}
                onChange={(e) => setSearchTom(e.target.value)}
                  ...
                  <div className="space-y-3">
                    <div className="flex items-start justify-between">
                      <div className="flex items-center space-x-2">
                        <img
                          src={conversation.participants[0].avatar || 'https://images.pexels.com/photos/614810/pexels-photo-614810.jpeg?auto=compress&cs=tinysrgb&w=50&h=50&dpr=2'}
                          alt={`${conversation.participants[0].firstName} ${conversation.participants[0].lastName}`}
                          className="w-8 h-8 rounded-full object-cover"
                        />
                        <div>
                          <p className="text-sm font-medium text-gray-900">{conversation.participants[0].firstName} {conversation.participants[0].lastName}</p>
                          <p className="text-xs text-gray-500 capitalize">Client</p>
                        </div>
                      </div>
                      <div className="flex flex-col items-end space-y-1">
                        <span className="text-xs text-gray-500">
                          {conversation.lastMessage && new Date(conversation.lastMessage.createdAt).toLocaleDateString('fr-FR')}
                        </span>
                ...
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <div className="flex items-center space-x-4 text-sm text-gray-600">
                      ...
                      {selectedConversationData.messages && selectedConversationData.messages.length > 0 &&
                        <div className="flex items-center space-x-2">
...
const ProtectedTechMessaging = () => (
  <ProtectedRoute roles={['technician']}>
    <TechMessaging />
  </ProtectedRoute>
);

export default ProtectedTechMessaging;